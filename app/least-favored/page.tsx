      ...
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className={`px-3 py-2 rounded-xl text-xs font-bold border transition ${
            votedType === 'up'
              ...
              : 'text-zinc-900 dark:text-white border-green-500 hover:bg-green-100 dark:hover:bg-green-900/30 disabled:opacity-50'
          }`}
        >
        ...
        <button
          ...
          className={`px-3 py-2 rounded-xl text-xs font-bold border transition ${
            votedType === 'down'
              ...
              : 'text-zinc-900 dark:text-white border-red-500 hover:bg-red-100 dark:hover:bg-red-900/30 disabled:opacity-50'
          }`}
        >
        ...
        {votedType && (
          <button
            ...
            className="px-3 py-2 rounded-xl text-xs font-bold border text-zinc-600 dark:text-zinc-300 border-zinc-300 dark:border-zinc-800 bg-white dark:bg-zinc-950 hover:bg-slate-100 dark:hover:bg-zinc-800 disabled:opacity-40"
          >
            Reset
          </button>
        )}
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8 text-zinc-900 dark:text-zinc-100 min-h-screen">
      ...
      {leastFavored.length === 0 ? (
        <p className="text-zinc-600 dark:text-zinc-400">No caption data found.</p>
      ) : (
